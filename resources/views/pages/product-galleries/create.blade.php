...
@section('content')
    <div class="card">
        ...
        <div class="card-body card-block">
            {{-- Bila untuk input gambar harus ada baris enctype="multipart/form-data" --}}
            <form action="{{ route('product-galleries.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select name="products_id" 
                        ...
                        <!-- Baris untuk memanggil data product id dan namanya, yang digunakan nanti untuk relasi gambarnya -->
