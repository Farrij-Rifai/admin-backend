...
class ProductGalleryController extends Controller
{
    ...
    {
        //ada with('product) karena tabel foto berelasi dengan tabel product dan ingin mengambil data product juga
    ...
    {
        //mengapa mengambil data product dulu karena
        //ingin menambahkan gambar sesuai dengan id foreignKey dari Product
